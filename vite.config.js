  ...
  build: {
    rollupOptions: {
      input: {
        ...
        "project-safehere": resolve(__dirname, "project-safehere.html"),
        "project-viagem": resolve(__dirname, "project-viagem.html"),
        "project-music-box": resolve(__dirname, "project-music-box.html"),
      },
    },
  },
});
