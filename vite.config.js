  ...
  build: {
    rollupOptions: {
      input: {
        ...
        // Add one entry per project page:
        ...
        'project-grand-games': resolve(__dirname, 'src/pages/project-grand-games.html'),
        ...
        'project-rive-demo': resolve(__dirname, 'src/pages/project-rive-demo.html'),
      },
    },
  },
});
